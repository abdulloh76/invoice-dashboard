...
type Invoice struct {
	...
	SenderAddress   *Address       `gorm:"constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" json:"senderAddress" binding:"required"`
	ClientAddress   *Address       `gorm:"constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" json:"clientAddress" binding:"required"`
